...
This document outlines the installation steps for Linux.

## Install MicroK8s with Multipass

First, install Multipass by following [Installing on Linux](https://multipass.run/docs/installing-on-linux)
...
Download the latest `opctl` for Linux from [our release page](https://github.com/onepanelio/cli/releases/latest)
