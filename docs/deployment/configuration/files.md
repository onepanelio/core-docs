...
:::important
The template below is automatically generated by following the instructions under [Install on single-node cluster](/docs/deployment/overview#installing-on-a-single-node-cluster) for your provider.
:::
