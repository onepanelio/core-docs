...
:::important
The template below is automatically generated by following the instructions under [Install on single-node cluster](../overview#installing-on-a-single-node-cluster) for your provider.
:::
...
:::important
The template below is automatically generated by following the instructions under [Install on public cloud](../overview#installing-on-public-cloud) for your provider.
:::
